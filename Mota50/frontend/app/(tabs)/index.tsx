...
export default function DashboardScreen() {
  ...
  // Finance and Fleet Manager dashboards have their own ScrollView, so don't wrap them
  if (user && (user.role === 'finance_officer' || user.role === 'finance' || user.role === 'fleet_manager')) {
    return (
