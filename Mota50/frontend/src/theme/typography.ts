...
export const typography = {
  ...
  // Font Weights - Use string values for better Android compatibility
  fontWeight: {
    normal: Platform.OS === 'android' ? 'normal' : ('400' as const),
    medium: Platform.OS === 'android' ? '500' : ('500' as const),
    semibold: Platform.OS === 'android' ? '600' : ('600' as const),
    bold: Platform.OS === 'android' ? 'bold' : ('700' as const),
  },
